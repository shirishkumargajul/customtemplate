	...
	function toggleWebServers() {
		...
		if (val == "yes") {
			var html = "<p>Choose your web server</p>\
				<select id=\"web_server_list\" name=\"web_server_list\">\
				<option value=\"null\">Choose One:</option>\
				<option value=\"\">Apache</option>\
				<option value=\"\">GWS</option>\
	...
	function toggleDbServers() {
		...
		if (val == "yes") {
			var html = "<p>Choose your database server</p>\
				<select id=\"database_server_list\" name=\"database_server_list\">\
				<option value=\"null\">Choose One:</option>\
				...
				<div class="contact_right">
					<div class="contact-form_grid">
						<s:form action="setSoftwareReq" method="post" namespace="/">
							...
							<p><s:text name="webServer"></s:text></p>
							...
							<p><s:text name="databaseServer"></s:text></p>
